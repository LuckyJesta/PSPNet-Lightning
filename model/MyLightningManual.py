...
class MyLightningModuleManual(L.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_miou", self.test_miou, on_step=True, on_epoch=True, prog_bar=True, sync_dist=True)
        self.log("test_acc", self.test_acc, on_step=True, on_epoch=True, prog_bar=True, sync_dist=True)
